...
namespace Zlipacket.VNZlipacket.Dialogue
{
    public class TextArchitect
    {
        ...
        private void Prepare_Fade()
        {
            ...
            Color32[] verrtexColor = textInfo.meshInfo[textInfo.characterInfo[0].materialReferenceIndex].colors32;
            ...
            for (int i = 0; i < textInfo.characterCount; i++)
            {
                ...
                {
                    for (int v = 0; v < 4; v++)
                        verrtexColor[characterInfo.vertexIndex + v] = colorVisible;
                }
                else
                {
                    for (int v = 0; v < 4; v++)
                        verrtexColor[characterInfo.vertexIndex + v] = colorHidden;
                }
            }
        ...
        private IEnumerator Build_Fade()
        {
            ...
            while (true)
            {
                ...
                for (int i = minRange; i < maxRange; i++)
                {
                    ...
                    for (int v = 0; v < 4; v++)
                        verrtexColor[characterInfo.vertexIndex + v].a = (byte)alphas[i];
